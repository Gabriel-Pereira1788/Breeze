...
export function Logo({ height, width }: Props) {
  return (
    <Svg width={width} height={height} viewBox="0 0 300 129.054807900848">
      <Defs>
        <LinearGradient id="SvgjsLinearGradient4202">
          <Stop stopColor="#7f00ff" offset="0"></Stop>
          <Stop stopColor="#e100ff" offset="1"></Stop>
        </LinearGradient>
        <LinearGradient id="SvgjsLinearGradient4205">
          <Stop stopColor="#ef4136" offset="0"></Stop>
          <Stop stopColor="#fbb040" offset="1"></Stop>
        </LinearGradient>
        <LinearGradient id="SvgjsLinearGradient4208">
          <Stop stopColor="#ef4136" offset="0"></Stop>
          <Stop stopColor="#fbb040" offset="1"></Stop>
        </LinearGradient>
      </Defs>
